...
%  Connecting Proton Compton Oscillation to the 136.1 Hz
%  Carrier Wave via the Icosahedral 60R-Grid
%
...
\hypersetup{
  ...
  pdftitle={The Discrete Frequency Divider},
...
\title{
  \textbf{The Discrete Frequency Divider: \\
